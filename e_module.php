...
$footer_js[] = SITEURL.$PLUGINS_DIRECTORY . 'gold_system/includes/gold_footer.js';
global $GOLD_PREF, $gold_obj,$eplug_js;
...
$eplug_css[]= e_PLUGIN . 'gold_system/includes/gold_system.css';
$eplug_css[]=  e_PLUGIN . 'gold_system/includes/tabview/css/dynamic_list.css';
$eplug_css[]= e_PLUGIN . 'gold_system/includes/tabview/css/tab-view.css';
$eplug_css[]=  e_PLUGIN . 'gold_system/includes/bubble/css/bubble-tooltip.css';

$footer_js[]= e_PLUGIN. 'gold_system/includes/gold_system.js';

$footer_js[]= e_PLUGIN. 'gold_system/includes/tabview/js/ajax.js';
$footer_js[]= e_PLUGIN. 'gold_system/includes/tabview/js/ajax-dynamic-list.js';
$footer_js[]= e_PLUGIN. 'gold_system/includes/tabview/js/tab-view.js';
$footer_js[]= e_PLUGIN. 'gold_system/includes/bubble/js/bubble-tooltip.js';
